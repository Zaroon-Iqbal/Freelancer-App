...
//        });
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), EditConsumerProfile.class));
            }
        });
        ...
        userDocRef.addSnapshotListener((document, e) -> {
            ...
            if(document != null && document.exists()){
                ...
                if(document.contains("ProfilePic")){
                    ...
                    imageRef.getDownloadUrl().addOnSuccessListener(uri -> Glide.with(ConsumerProfile.this).load(uri).into(profilePic));
                }
            }
